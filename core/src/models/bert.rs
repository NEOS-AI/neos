//! this file has been copied from the candle-transformers project and modified
//! to include an optional pooler layer and use an attention mask for padding tokens.
//!
...
impl Module for BertPooler {
    fn forward(&self, hidden_states: &Tensor) -> Result<Tensor> {
        let first_token_tensor = hidden_states.get_on_dim(1, 0)?;
...
impl BertModel {
    ...
    pub fn forward(
        ...
        match &self.pooler {
            Some(pooler) => pooler.forward(&sequence_output),
